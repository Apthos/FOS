...
# from /Library/Frameworks/Python.framework/Versions/3.5/lib/python3.5/site-packages/scipy/linalg/_decomp_update.cpython-35m-darwin.so
# by generator 1.145
"""
...
def qr_delete(Q, R, k, int_p=1, which='row', overwrite_qr=False, check_finite=True): # real signature unknown; restored from __doc__
    """
...
def qr_insert(Q, R, u, k, which='row', rcond=None, overwrite_qru=False, check_finite=True): # real signature unknown; restored from __doc__
    """
