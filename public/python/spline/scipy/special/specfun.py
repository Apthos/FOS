...
# from /Library/Frameworks/Python.framework/Versions/3.5/lib/python3.5/site-packages/scipy/special/specfun.cpython-35m-darwin.so
# by generator 1.145
"""
...
def csphik(n, z): # real signature unknown; restored from __doc__
    """
    nm,csi,cdi,csk,cdk = csphik(n,z)
...
def csphjy(n, z): # real signature unknown; restored from __doc__
    """
    nm,csj,cdj,csy,cdy = csphjy(n,z)
...
def sphi(n, x): # real signature unknown; restored from __doc__
    """
    nm,si,di = sphi(n,x)
...
def sphj(n, x): # real signature unknown; restored from __doc__
    """
    nm,sj,dj = sphj(n,x)
...
def sphk(n, x): # real signature unknown; restored from __doc__
    """
    nm,sk,dk = sphk(n,x)
...
def sphy(n, x): # real signature unknown; restored from __doc__
    """
    nm,sy,dy = sphy(n,x)
