...
# from /Library/Frameworks/Python.framework/Versions/3.5/lib/python3.5/site-packages/scipy/special/_ellip_harm_2.cpython-35m-darwin.so
# by generator 1.145
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import scipy as scipy # /Library/Frameworks/Python.framework/Versions/3.5/lib/python3.5/site-packages/scipy/__init__.py
...
__pyx_capi__ = {
    '_F_integrand': None, # (!) real value is ''
    '_F_integrand1': None, # (!) real value is ''
    '_F_integrand2': None, # (!) real value is ''
    '_F_integrand3': None, # (!) real value is ''
    '_F_integrand4': None, # (!) real value is ''
}
